from src.algorithm.improved_vns import create_planning_df, time_checker, total_cost
...
class GreedyAlgorithm:
    ...
    def __init__(self, all_orders_df, travel_time_matrix, travel_time_with_orderids, service_time_matrix):
