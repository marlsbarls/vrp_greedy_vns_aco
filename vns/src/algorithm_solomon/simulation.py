...
file_names = ["C101", "C201", "R101", "R201", "RC101", "RC201"]
#file_names = ["C101"]
#file_names = ["C101_10_percent_dynamicity"]
test_name = "static_sol_test"
test_type = "static"  # static or dynamic # caution: dynamic not yet implemented
validation_runs = 10
    ...
    if (test_type == "static"):
        ...
        for i in range(validation_runs):
            ...
            file_name = os.path.join(
                dir_name, 'data', 'solomon', file + '.csv')
            ...
            savings = SavingsAlgorithm(
                all_orders_df, dist_matrix, capacity, servicetime, readytime, duetime)
            ...
            result_df.to_csv(
                "%s/experiments/solomon/%s/%s/result.csv" % (dir_name, file, test_name))
